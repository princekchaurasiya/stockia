...
return [
    ...
    /*
     ...
     |--------------------------------------------------------------------------
     |
     | Set DEBUGBAR_ENABLED=true in .env to show the debug bar. When not set,
     | it follows APP_DEBUG. Set to false to hide the bar even when APP_DEBUG is true.
     |
     | You can provide an array of URI's that must be ignored (eg. 'api/*')
     |
     */

    'enabled' => filter_var(env('DEBUGBAR_ENABLED', env('APP_DEBUG', false)), FILTER_VALIDATE_BOOLEAN),
